...
namespace primerjanjeAvtomobilov.Models
{
    ...
    {
        public static Avtomobili avto;
        public static List<Avtomobili> avti = new List<Avtomobili>();
        ...
        var httpClient = new HttpClient();
            ...
            foreach (var htmlOglas in htmlSeznamOglasov)
            {
                ...
                //Dodajanje avtomobilov

                avtoInner = new Avtomobili(idCar,naslov,prevozeni,menjalnik,motor,cena, imgUrl);
                avti.Add(avtoInner);
                idCar++;
            }
        }
        ...
        private static async void GetAvto(string url)
        {
            ...
            //Console.WriteLine("Menjalnik: " + menjalnik + "/");
            //Console.WriteLine("Cena: " + cena + "/");
            avto = new Avtomobili (1, naslov, prevozeni, menjalnik, motor, cena, imgUrl);
        }
